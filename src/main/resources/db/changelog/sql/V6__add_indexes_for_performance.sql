...
CREATE INDEX IF NOT EXISTS idx_report_dates ON periodic_reports(report_from_date, report_to_date);
CREATE INDEX IF NOT EXISTS idx_submit_dates ON periodic_reports(submit_start_at, submit_end_at);

-- Course table indexes
CREATE UNIQUE INDEX IF NOT EXISTS idx_course_code ON courses(course_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_student_code ON students(student_code);
CREATE UNIQUE INDEX IF NOT EXISTS idx_user_id ON students(user_id);
CREATE INDEX IF NOT EXISTS idx_github_username ON students(github_username);

-- Project table indexes
CREATE UNIQUE INDEX IF NOT EXISTS idx_project_code ON projects(project_code);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_staff_code ON lecturers(staff_code);
...
CREATE INDEX IF NOT EXISTS idx_semester_name ON semesters(semester_name);
CREATE INDEX IF NOT EXISTS idx_semester_dates ON semesters(start_date, end_date);

-- RefreshToken table indexes
CREATE UNIQUE INDEX IF NOT EXISTS idx_token ON refresh_tokens(token_hash);
CREATE INDEX IF NOT EXISTS idx_refresh_user_id ON refresh_tokens(user_id);
CREATE INDEX IF NOT EXISTS idx_expiry_date ON refresh_tokens(expires_at);

-- GithubRepository table indexes
CREATE INDEX IF NOT EXISTS idx_github_project_id ON github_repositories(project_id);
CREATE INDEX IF NOT EXISTS idx_repo_url ON github_repositories(repo_url);
CREATE INDEX IF NOT EXISTS idx_repo_owner ON github_repositories(owner);
CREATE INDEX IF NOT EXISTS idx_is_selected ON github_repositories(is_selected);
...
CREATE INDEX IF NOT EXISTS idx_commit_date ON commit_contributions(created_at);
...
CREATE INDEX IF NOT EXISTS idx_commit_hash ON commit_details(commit_hash);
CREATE INDEX IF NOT EXISTS idx_committed_at ON commit_details(committed_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_jira_key ON jira_projects(jira_key);
